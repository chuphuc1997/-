...
const TransactionsPage: React.FC<Props> = ({ transactions, onEdit, onDelete, onAdd }) => {
    ...
    <div className="p-4 md:p-6 max-w-5xl mx-auto space-y-4">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 space-y-3">
        <div className="flex flex-wrap gap-2">
          ...
          <input
            ...
            className="px-3 py-1.5 rounded-xl text-xs font-medium border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
        </div>
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            <input
              ...
              className="w-full pl-8 pr-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
            />
          ...
          <select
            ...
            className="px-3 py-2 rounded-xl border border-gray-200 text-xs font-medium bg-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
          >
      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
          ...
          <button onClick={onAdd} className="mt-4 px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-semibold hover:bg-indigo-700 transition-colors">
            + Thêm giao dịch
          </button>
        </div>
      ) : (
